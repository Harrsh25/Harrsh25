...
const { applyLeave, getMyLeaves, getLeaveBalance, getLeaveById, cancelLeave, approveLeave, rejectLeave, getPendingApprovals, getLeaveTypes } = require('../controllers/leaveController');
